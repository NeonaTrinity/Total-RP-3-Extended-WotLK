...
|cff00ff00C'est un bon endroit où placer l'activation de la première quête.]=],
	["CA_NAME"] = "Nom de campagne",
	["CA_NAME_NEW"] = "Nouvelle campagne",
	["CA_NAME_TT"] = "C'est le nom de votre campagne. Il apparaît dans le journal en quêtes.",
...
|cff00ff00Il est donc conseillé de commencer l'ID d'une quête par quete_#, où le # est le numéro d’apparition voulu de la quête dans le journal.]=],
	...
	["CONF_MAIN"] = "Paramètres de Extended",
...
|cffff9900N'oubliez pas d'enregistrer vos modifications avant de revenir à la liste de la base de données !]=],
	...
	["DEBUG_QUEST_STEP"] = "Aller à une étape de la quête.",
...
Seulement nécessaire si la direction de dialogue ci-dessus n'est pas mise à "Aucun".]=],
	["DI_NEXT"] = "Index d'étape suivante",
...
%s]=],
	...
	["DR_STASHES_EDIT"] = "Éditer cachette",
	["DR_STASHES_ERROR_OUT_SYNC"] = "Cachette non synchronisée, veuillez réessayer.",
...
NB : Elle leur sera toujours accessible, s'ils savent déjà où elle est.]=],
	["DR_STASHES_MAX"] = "50 personnages max",
...
Le radar sera lancé 3 secondes, patience !]=],
...
Ancien ID: |cff00ffff"%s"|r]=],
   ...
   y: %.2f]=],
	...
	["INV_PAGE_SEQUENCE_TT"] = [=[Vous pouvez changer la pose de votre personnage en entrant une ID d'animation ici et en sélectionnant le cadre d'animation avec la barre de défilement ci-dessous.

Attention : Si l'animation grésille, c'est qu'il y a un problème de l'animation pour le modèle de votre race. Si cela arrive, veuillez choisir une autre animation.]=],
...
|cffff9900De plus, le contenant principal peut facilement être ouvert avec le bouton d'inventaire sur la barre d'action TRP.]=],
	["INV_TU_3"] = [=[Pour les objets qui équipent directement le personnage (pas dans un sac), s'ils sont équipables (ce qui est un choix de l'auteur), |cffff9900vous pouvez indiquer où ils sont sur votre personnage.

|cffff9900Pour cela, cliquez sur le point à côté de l'objet et placez le marqueur sur votre personnage. Vous pouvez aussi tourner votre personnage et choisir sa pose.

|cffff9900Quand quelqu'un utilise l'outil d'inspection sur vous, il ou elle verra le marqueur avec la pose adéquate !
...
Vous pouvez déposer des objets (presque) partout dans le monde. |cffff9900Vous pouvez ensuite revenir les ramasser plus tard en utilisant le bouton "Rechercher des objets" dans la barre d'action TRP3.
...
|cffff9900Vous ne pouvez pas finir un troc tant que vous n'avez pas toute l'information à jour sur les objets que vous devriez recevoir.]=],
	...
	["IT_EX_EMPTY_DRAG"] = "Vous pouvez glisser les objets ici.",
...
Vous pourrez aussi Ctrl+Clic droit sur l'objet dans votre inventaire pour configurer la sécurité plus tard.]=],
	["SEC_HIGH"] = "Haut",
	["SEC_HIGH_TT"] = "Cet objet et tous ses éléments liés sont sécurisés et n'utilisent pas d'effets gênants ou malveillants.",
	["SEC_LEVEL"] = "Niveau de sécurité",
	["SEC_LEVEL_DETAIL"] = "Cliquer pour voir le détail du script problématique.",
	["SEC_LEVEL_DETAIL2"] = "Cliquer pour voir le détail du script problématique et configurer ce qui peut être exécuté.",
