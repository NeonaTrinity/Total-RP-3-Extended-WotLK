...
function exchangeFrame.init()
	...
	if not exchangeFrame.Background then
		exchangeFrame.Background = exchangeFrame:CreateTexture(nil, "BACKGROUND");
		exchangeFrame.Background:SetAllPoints(exchangeFrame);
	end
