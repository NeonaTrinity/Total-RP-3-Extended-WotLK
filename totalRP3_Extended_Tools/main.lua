...
local function onStart()
	...
	TRP3X_WOTLK.ensureEvent(Events.ON_OBJECT_UPDATED);
	...
	TRP3X_WOTLK.ensureEvent(TRP3_API.events.NAVIGATION_EXTENDED_RESIZED);
	...
	NavBar_Initialize(toolFrame.navBar, "TRP3X_NavButtonTemplate", homeData, toolFrame.navBar.home, toolFrame.navBar.overflow);
