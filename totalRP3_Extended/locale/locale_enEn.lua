...
|cff00ff00We won't, for now, heavily document all effect ID and arguments as we consider this effect restricted to users capable of looking at the addon source code. ;)]],
	...
	EFFECT_DISPET = "Dismiss non-combat companion",
	EFFECT_DISPET_TT = "Dismiss the currently summoned non-combat companion (critter).",
	EFFECT_RANDSUM = "Summon random non-combat companion",
	EFFECT_RANDSUM_TT = "Summon a random non-combat companion from your Wrath critter collection.",
